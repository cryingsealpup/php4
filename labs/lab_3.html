        ...
        <ol class="list-decimal pl-8">
            <li>
                <details class="p-4 mb-5 shadow-lg rounded-xl">
                    ...
                    <p class='p-3'> На скрине — запуск index.php из корня (текущая работа проводится в среде разработки php ddev).
                        Для того, чтобы это получить, потребовалось также создать простенький htaccess:</p>
                    <pre class='bg-black text-white whitespace-pre-wrap'>
    RewriteEngine On
